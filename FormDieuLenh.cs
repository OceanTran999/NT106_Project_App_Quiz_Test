...
namespace Project_Final_Semester__NT106_
{
    public partial class FormDieuLenh : Form
    {
        ...
        string conStringCauHoiDoAn = "Data Source=LAPTOP-MA2GS6K5;Initial Catalog=CAUHOIDA;Integrated Security=True";
        //string conStringThongTin = "Data Source=LAPTOP-NHNMFFBB;Initial Catalog = THONGTIN; Integrated Security = True";
        string conStringCauHoiNMM = "Data Source=LAPTOP-MA2GS6K5;Initial Catalog=CAUHOINMM;Integrated Security=True";
        string conStringCauHoiKTMT = "Data Source=LAPTOP-MA2GS6K5;Initial Catalog=CAUHOIKTMT;Integrated Security=True";
        string conStringCauHoiKTCT = "Data Source=LAPTOP-MA2GS6K5;Initial Catalog=CAUHOIKTCT;Integrated Security=True";
        ...
        void NewReceive(string data)
        {
            try
            {
                ...
                else
                {
                    ...
                    //Lưu vào database
                    SqlConnection sqlConstring = new SqlConnection("Data Source=LAPTOP-MA2GS6K5;Initial Catalog=LuuKQuaClient;Integrated Security=True");
